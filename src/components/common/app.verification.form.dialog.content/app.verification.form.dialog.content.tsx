...
export const AppVerificationMethod: React.FC<AppVerificationMethodProps> = (props: any) => (
    <>
        ...
        <AppButton disabled={false} label="Send via Whatsapp" style={{backgroundColor: "#00CB56"}} onClick={props.onOpenOtpForm} />
        ...
        <AppButton disabled={false} label="Send via Sms" onClick={props.onOpenOtpForm} />
    </>
);