  ...
  const addToCart = () => {
    if (product) {
      const addTProductToCart = createAction(
        `ADD_PRODUCT_TO_CART_${product.id}`,
        (dataR: any = {}, dt: any = {}) => ({
          payload: {
            data: dataR,
            details: dt,
  ...
  return (
    ...
    >
      {systemConfig && product ? (
        ...
        >
          <Link href={`/product/${product.id}`} className="no-underline" style={{color:"#000"}} passHref>
            <img
            ...
            <div>
              ...
              <div className="flex flex-column gap-1">
                ...
                <div className="text-700 line-clamp-3 mb-2 md:text-sm text-xs">
